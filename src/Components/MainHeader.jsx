...
function MainHeader() {
  ...
  return (
    <>
      <header className='w-full h-22  flex px-10   items-center justify-center fixed z-999 '>
              <div className='w-200 h-11  gap-4 flex bg-[#252839]  items-center px-5 rounded-2xl'>
                  ...
                  <div className='w-30  h-10 flex items-center'>
                      <span className='text-xl text-[#F2B632]'> PawElite Care</span>
                  </div>

                  <div className='w-140 h-10 text-[#F2B632] flex  items-center gap-4 justify-end p-2 '>
                  ...
                  <div className='relative' onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
                      ...
                      {showDropdown && (
                   <div className='w-min h-60 bg-red-50 p-2 mt-40 flex gap-1.5 absolute -right-10 bottom-0 -top-30 z-50 border-none'>
                  <div className='w-30 bg-[#F5F5F5]'>
                      <p className='hover:text-x1 text-[#707072] cursor-pointer hover:underline hover:text-[#111111] hover:font-bold'
                  ...
                  {activeSection === "Product" && (
                   ...
                   <NavLink to="/about" className={({ isActive }) => isActive ? ' text-[#ffffff]' : "text-[#F2B632] hover:text-xl hover:cursor-pointer"}>About</NavLink>
                   <NavLink to="/contact" className={({ isActive }) => isActive ? ' text-[#ffffff]' : "text-[#F2B632] hover:text-xl hover:cursor-pointer"}>Contact</NavLink>
                  <div className='flex items-end '>
                      <div className='flex p-5 gap-2 text-xl h-10 items-center justify-center'>
                          {/* <LuSearch className='hover:text-xl hover:cursor-pointer'/> */}
